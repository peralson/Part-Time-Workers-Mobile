...
const ProfilePrivateDetails = ({ navigation, route, updateProfileLegal }) => {
				...
				<View style={{ marginHorizontal: 16 }}>
					...
					<SideScrollPicker>
						<ImagePickerComponent
							...
							placeholder={formik.values.dniFront}
							onChange={formik.handleChange("dniFront")}
						/>
						<ImagePickerComponent
							title="Imagen trasera"
							placeholder={formik.values.dniBack}
							onChange={formik.handleChange("dniBack")}
						/>
					</SideScrollPicker>
					<CustomInputComponent
