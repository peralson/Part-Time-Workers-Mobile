...
const ProfileContractsScreen = ({ navigation, token }) => {
      ...
      {loading ? (
        ...
        >
          {error ? (
            ...
            <EmptyList
              quote="No tienes ningún contrato."
...
export default connect(mapStateToProps, null)(ProfileContractsScreen);